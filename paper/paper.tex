...
The 45 failures in Tier~5 are from error accumulation over 200 iterative steps on random programs---since the model is applied in a loop (output fed back as input), any per-step rounding imprecision in floating-point arithmetic compounds over many steps.
