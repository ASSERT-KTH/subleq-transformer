#!/bin/bash
#SBATCH --job-name=subleq-p1s0
#SBATCH --output=logs/phase1_seed0_%j.out
#SBATCH --error=logs/phase1_seed0_%j.err
#SBATCH --gpus-per-node=T4:1
#SBATCH --time=04:00:00
#SBATCH --account=naiss2025-5-243

# Run Phase 1 (oracle) and Phase 2/3/4 on seed 0 (existing checkpoint)
# This runs in parallel with the training of seeds 1-4
